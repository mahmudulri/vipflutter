...
class FIftyplusAdmin extends StatefulWidget {
  const FIftyplusAdmin({super.key});

  @override
  State<FIftyplusAdmin> createState() => _FIftyplusAdminState();
}

class _FIftyplusAdminState extends State<FIftyplusAdmin> {
                        ...
                        GestureDetector(
                          onTap: () {
                            if (finaData_1 == "" &&
                              ...
                              FirebaseFirestore.instance
                                  .collection('FiftyPlusViips')
                                  .add({
                                "legue": finaData_1,
                                "team": finaData_2,
                                "score1": finaData_3,
                                "score2": finaData_4,
                                "timeData": FieldValue.serverTimestamp(),
                              });
                              ...
                              child: Container(
                                ...
                                child: StreamBuilder(
                                  stream: FirebaseFirestore.instance
                                      .collection("FiftyPlusViips")
                                      .orderBy("timeData", descending: true)
                                      .snapshots(),
                                  builder: (context,
